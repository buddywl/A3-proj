...
public class SLLTest {
    ...
    public static <T> String verifySLL(SLL<T> list, T[] values) {
        ...
        for (int i = 0; i < values.length; i++) {
            if (((here != null) && (values[i].equals(here.getData())))) {
                result.append("element ").append(values[i]).append("; ");
            }
            if (here == null) {
...
//        System.out.println(s);
    ...
    public void check_methods() {
        ...
        Assert.assertNull("empty head is null", list.getHead());
        Assert.assertNull("empty tail is null", list.getTail());
    ...
    public void test_addFirst_1() {
        ...
        Assert.assertFalse("list of 1 isn't empty", list.isEmpty());
        Assert.assertSame("same head and tail of singleton", list.getHead(), list.getTail());
        Assert.assertEquals("data correct", "A", list.getHead().getData());
        Assert.assertNull("tail's next is null", list.getTail().getNext());
    }
    ...
    public void test_addFirst_2() {
        ...
        list.addFirst("A");
        list.addFirst("B");
        Assert.assertFalse("list of 2 isn't empty", list.isEmpty());
        Assert.assertSame("second node is tail", list.getHead().getNext(), list.getTail());
        Assert.assertEquals("first element is B", "B", list.getHead().getData());
        Assert.assertEquals("second element is A", "A", list.getHead().getNext().getData());
        Assert.assertNull("tail's next is null", list.getTail().getNext());
    }
    ...
    public void test_addFirst_3() {
        ...
        list.addFirst("B");
        list.addFirst("C");
        Assert.assertFalse("list of 3 isn't empty", list.isEmpty());
        Assert.assertSame("third node is tail", list.getHead().getNext().getNext(), list.getTail());
        Assert.assertEquals("first element is C", "C", list.getHead().getData());
        Assert.assertEquals("second element is B", "B", list.getHead().getNext().getData());
        Assert.assertEquals("third element is A", "A", list.getHead().getNext().getNext().getData());
        Assert.assertNull("tail's next is null", list.getTail().getNext());

        String s = verifySLL(list, cba);
        Assert.assertEquals("3-list contents " + s, "", s);
    }
    ...
    public void test_toString() {
        ...
        list.addFirst("C");
        Assert.assertEquals("list [C, B, A]", "[C, B, A]", list.toString());
    }
    @Test
    public void test_addLast() {
        ...
        list.addLast("A");
//        String s = verifySLL(list, a);
//        Assert.assertTrue("addLast -> A " + s, s.equals("element A; "));
        list.addLast("B");
        String s = verifySLL(list, ab);
        Assert.assertTrue("addLast -> AB" + s, s.equals("element A; element B; "));
        list.addLast("C");
        s = verifySLL(list, abc);
        Assert.assertTrue("addLast -> ABC " + s, s.equals("element A; element B; element C; "));
    }
    @Test
    public void test_addAfter() {
        ...
        list.addAfter(list.getHead(), "B");
        String s = verifySLL(list, ab);
        Assert.assertTrue("A.addAfter(A,B)" + s, s.equals("element A; element B; "));
        list.addAfter(list.getTail(), "C");
        s = verifySLL(list, abc);
        Assert.assertTrue("AB.addAfter(B,C)" + s, s.equals("element A; element B; element C; "));
        list.addAfter(list.getHead().getNext(), "D");
        s = verifySLL(list, abdc);
        Assert.assertTrue("ABC.addAfter(B,D)" + s, s.equals("element A; element B; element D; element C; "));
    ...
    public void test_removeFirst() {
        ...
        Assert.assertEquals("remove C", "C", list.removeFirst());
        String s = verifySLL(list, ba);
        Assert.assertTrue("removeFirst --> BA " + s, s.equals("element B; element A; "));
        Assert.assertTrue("remove B", list.removeFirst().equals("B"));
        s = verifySLL(list, a);
        Assert.assertTrue("removeFirst --> A " + s, s.equals("element A; "));
        Assert.assertTrue("remove A", list.removeFirst().equals("A"));
        s = verifySLL(list, empty);
        Assert.assertTrue("removeFirst -> empty " + s, s.equals(" problems at "));
    }
    ...
    public void test_removeLast() {
        ...
        String s = verifySLL(list, ab);
        Assert.assertTrue("removeLast -> AB" + s, s.equals("element A; element B; "));
        Assert.assertTrue("removeLast B", list.removeLast().equals("B"));
        s = verifySLL(list, a);
        Assert.assertTrue("removeLast -> A" + s, s.equals("element A; "));
        Assert.assertTrue("removeLast A", list.removeLast().equals("A"));
        s = verifySLL(list, empty);
        Assert.assertTrue("removeLast -> empty" + s, s.equals(" problems at "));
    }
    ...
    public void test_removeAfter() {
        ...
        String s = verifySLL(list, ab);
        Assert.assertTrue("ABC removeAfter B -> AB" + s, s.equals("element A; element B; "));
        Assert.assertTrue("AB after A", list.removeAfter(list.getHead()).equals("B"));
        s = verifySLL(list, a);
        Assert.assertTrue("AB removeAfter A -> A" + s, s.equals("element A; "));
...
//        Assert.assertTrue("A removeAfter null -> empty" + s, s.equals(""));
    ...
    public void test_size() {
        ...
        Assert.assertTrue("size of CBA", 7 == list.size());
    }
//
//    @Test
